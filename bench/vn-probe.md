...
Generated: 2026-09-18T19:21:08+00:00 · swctx bin: `/Users/phuongnam/02.AI/NP_AI_macos/tools/swctx/bench/../.build/release/swctx` · limit: recall@5
...
| seo-07 | vi | vn_to_vn | tài liệu quy trình chuẩn để push nội dung bài viết lên site | `WORKFLOW.md` | 5 | — | 5 |
...
| crm-01 | vi | vn_to_vn | script tính chấm công của nhân viên từ nhật ký hoạt động | `crm-nam-pham/09-build/cham_cong.py` | — | — | 2 |
...
Median CLI latency per call: fts 297 ms · semantic 811 ms · auto 895 ms.
...
- **seo-07** (vi) "tài liệu quy trình chuẩn để push nội dung bài viết lên site" → `WORKFLOW.md` — fts rank 5, semantic rank —, auto rank 5
