#!/usr/bin/env python3
"""rerank_eval_v2m3.py — bge-reranker-v2-m3 spike evaluation for swctx.

Identical methodology to bench/rerank_eval.py but invokes
`swctx rerank2` (XLM-R cross-encoder) instead of `swctx rerank`
(amberoad mBERT). Baseline is still `swctx search --mode auto`.

    python3 bench/rerank_eval_v2m3.py                  # table on stdout
    python3 bench/rerank_eval_v2m3.py --json           # machine-readable
    python3 bench/rerank_eval_v2m3.py --out file.json  # also save raw data
"""
...
def main():
    ...
    ap.add_argument("--rerank-cmd", default="rerank2",
