...
Generated: 2026-09-18T10:41:24+00:00 · swctx bin: `/Users/phuongnam/02.AI/NP_AI_macos/tools/swctx/bench/../.build/release/swctx` · limit: recall@5
...
| seo-03 | vi | vn_to_vn | script tạo file excel để sinh link utm cho chiến dịch zalo linkedin | `scripts/p8_utm_builder.py` | 1 | — | 1 |
...
| seo-08 | en | en_control | generate hero image and set featured image for articles missing one | `scripts/p8_fix_featured_images.py` | 1 | 5 | 2 |
...
| crm-06 | vi | vn_to_vn | tài liệu giải thích CEO đăng nhập bằng google qua cloudflare access | `crm-nam-pham/07-docs/DANG_NHAP.md` | 1 | — | — |
...
|---|---|---|---|
| 8.P8_SEO_Clean (n=8) | 2/8 (25%) | 1/8 (12%) | 3/8 (38%) |
| 18.CRM-Nam-Pham (n=8) | 4/8 (50%) | 0/8 (0%) | 3/8 (38%) |
| ALL (n=16) | 6/16 (38%) | 1/16 (6%) | 6/16 (38%) |
| lang=vi (n=14) | 5/14 (36%) | 0/14 (0%) | 5/14 (36%) |
| lang=en (n=2) | 1/2 (50%) | 1/2 (50%) | 1/2 (50%) |
| tag=vn_to_vn (n=12) | 5/12 (42%) | 0/12 (0%) | 5/12 (42%) |
| tag=vn_to_en (n=2) | 0/2 (0%) | 0/2 (0%) | 0/2 (0%) |
| tag=en_control (n=2) | 1/2 (50%) | 1/2 (50%) | 1/2 (50%) |

Median CLI latency per call: fts 64 ms · semantic 330 ms · auto 385 ms.
...
- **seo-03** (vi) "script tạo file excel để sinh link utm cho chiến dịch zalo linkedin" → `scripts/p8_utm_builder.py` — fts rank 1, semantic rank —, auto rank 1
...
- **crm-06** (vi) "tài liệu giải thích CEO đăng nhập bằng google qua cloudflare access" → `crm-nam-pham/07-docs/DANG_NHAP.md` — fts rank 1, semantic rank —, auto rank —
...
Vietnamese queries (n=14): FTS recall 36%, semantic 0%, auto 36%. English controls (n=2): FTS 50%, semantic 50%, auto 50%.

Split by target language — VN query onto Vietnamese-heavy content (vn_to_vn, n=12): FTS 42% / semantic 0%. VN query onto English-only code (vn_to_en, n=2): FTS 0% / semantic 0%. The vn_to_en rows are the purest test of whether the embedding model bridges languages, since no Vietnamese token in the index can match them.
